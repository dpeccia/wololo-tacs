...
object RepoUsers : Repository<User> {
    ...
    fun getUserByLogin(loginData: UserForm): Either<CustomException.Unauthorized, User> = getAll().find {it.isUserByLoginData(loginData)}.rightIfNotNull { CustomException.Unauthorized.BadLoginException() }
