...
class Town(val id: Int, val name: String, val coordinates: Coordinates, val elevation: Double, val townImage: String, val stats: TownStats, val borderingTowns: List<String>) : Requestable {
    @DBRef
    var owner: User? = null
    ...
    companion object {
        ...
        fun new(_name: String, _elevation: Double, _coordinates: Coordinates = Coordinates(0f,0f), _townImage: String = "",
                _borderingTowns: List<String>, _stats: TownStats = TownStats(0,0)): Town =
