...
class GameTests {
    ...
    inner class GameCreation {
        ...
        fun `creating a 2 player game with two towns distributes them 1 for each player`() {
            val game = Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy()))), normalMode, mailSender)
        ...
        fun `creating a game distributes towns with the available players evenly`() {
            val game = Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))), normalMode, mailSender)
        ...
        fun `Attempting to create a game with more players than towns throws IlegalGameException`() {
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy()))), normalMode, mailSender) }
        }

        @Test
        fun `Attempting to create a game without players throws IlegalGameException`() {
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(listOf(), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))), normalMode, mailSender) }
        }

        @Test
        fun `Attempting to create a game with one player throws IlegalGameException`() {
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(listOf(user1), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))), normalMode, mailSender) }
        }

        @Test
        fun `Can successfully create a game with 2 players`() {
            assertDoesNotThrow { Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))), normalMode, mailSender) }
        }

        @Test
        fun `Can successfully create a game with 3 players`() {
            assertDoesNotThrow { Game.new(listOf(user1, user2, user3), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))), normalMode, mailSender) }
        }

        @Test
        fun `Can successfully create a game with 4 players`() {
            assertDoesNotThrow { Game.new(fourPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))), normalMode, mailSender) }
        }
        ...
        fun `Attempting to create a game with 5 players throws IllegalGameException`() {
            ...
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(fivePlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))), normalMode, mailSender) }
        }
        ...
        fun `There are gauchos in all the towns when the Game begins`() {
            ...
            Game.new(twoPlayerList, jujuy, normalMode, mailSender)
            assertAll(
    ...
    inner class Surrender {
        ...
        fun `surrender a game leaving only one player remaining cancels the game`() {
            val twoPlayerGame = Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy()))), normalMode, mailSender)
        ...
        fun `surrender a game leaving more than on players remaining continues the game`() {
            val multiplePlayersGame = Game.new(fourPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy()))), normalMode, mailSender)
