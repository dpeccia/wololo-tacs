...
class GameTests {
    ...
    fun fixture() {
        ...
        game1 = Game.new(listOf(user1, user99), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy()))))
        game1.turn = user1
    ...
    inner class GameCreation {
        ...
        fun `creating a 2 player game with two towns distributes them 1 for each player`() {
            val game = Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy()))))
        ...
        fun `creating a game distributes towns with the available players evenly`() {
            val game = Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))))
        ...
        fun `Attempting to create a game with more players than towns throws IlegalGameException`() {
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy())))) }
        }

        @Test
        fun `Attempting to create a game without players throws IlegalGameException`() {
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(listOf(), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy())))) }
        }

        @Test
        fun `Attempting to create a game with one player throws IlegalGameException`() {
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(listOf(user1), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy())))) }
        }

        @Test
        fun `Can successfully create a game with 2 players`() {
            assertDoesNotThrow { Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy())))) }
        }

        @Test
        fun `Can successfully create a game with 3 players`() {
            assertDoesNotThrow { Game.new(listOf(user1, user2, user3), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy())))) }
        }

        @Test
        fun `Can successfully create a game with 4 players`() {
            assertDoesNotThrow { Game.new(fourPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy())))) }
        }
        ...
        fun `Attempting to create a game with 5 players throws IllegalGameException`() {
            ...
            assertThrows<CustomException.BadRequest.IllegalGameException> { Game.new(fivePlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy())))) }
        }
    ...
    inner class MoveGauchos {
        ...
        fun `trying to move gauchos when it is not your turn throws NotYourTurnException`() {
            val game2 = Game.new(listOf(user1, user2), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy()))))
            game2.turn = user1
    ...
    inner class Surrender {
        ...
        fun `surrender a game leaving only one player remaining cancels the game`() {
            val twoPlayerGame = Game.new(twoPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy()))))
        ...
        fun `surrender a game leaving more than on players remaining continues the game`() {
            val multiplePlayersGame = Game.new(fourPlayerList, Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy()))))
    ...
    inner class Turn {
        ...
        fun `successfully finish turn unlocks all towns from User`() {
            val game2 = Game.new(listOf(user1, user2), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))))
            game2.turn = user1
        ...
        fun `in a 2 player game, finishing turn twice results in the initial player's turn`() {
            val twoPlayerGame = Game.new(listOf(user1, user2), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy()))))
        ...
        fun `if the last player of the first round, finishes his turn and didnt win, turn is changed to first player again`() {
            ...
            val game2 = Game.new(listOf(user1, user2, user3), Province("a_province", ArrayList(listOf(town1.copy(), town2.copy(), town3.copy(), town4.copy(), town5.copy()))))
